			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/reporting_information/edit','add')" @click="to_form('/reporting_information/edit')" > 举报 </button>
											<button class="btn btn-primary details_btn" v-if="$check_action('/exchange_forum/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/exchange_forum/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
