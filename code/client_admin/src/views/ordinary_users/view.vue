		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="用户年龄" prop="user_age">
						...
						v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','user_age')) || (!form_sub['ordinary_users_id'] && $check_field('add','user_age'))"></el-input-number>
				...
				<el-form-item label="用户积分" prop="user_points">
						...
						v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','user_points')) || (!form_sub['ordinary_users_id'] && $check_field('add','user_points'))"></el-input-number>
