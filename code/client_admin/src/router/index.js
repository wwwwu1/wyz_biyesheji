...
const routes = [
	...
	// 论坛分类路由
	{
		path: '/forum_classification/table',
		name: 'forum_classification_table',
		component: () => import('../views/forum_classification/table.vue'),
		meta: {
			index: 0,
			title: '论坛分类列表'
		}
	...
	{
		path: '/forum_classification/view',
		name: 'forum_classification_view',
		component: () => import('../views/forum_classification/view.vue'),
		meta: {
			index: 0,
			title: '论坛分类详情'
		}
	...
	// 举报信息路由
	{
		path: '/reporting_information/table',
		name: 'reporting_information_table',
		component: () => import('../views/reporting_information/table.vue'),
		meta: {
			index: 0,
			title: '举报信息列表'
		}
	...
	{
		path: '/reporting_information/view',
		name: 'reporting_information_view',
		component: () => import('../views/reporting_information/view.vue'),
		meta: {
			index: 0,
			title: '举报信息详情'
		}
	...
	// 参考信息路由
	{
		path: '/reference_information/table',
		name: 'reference_information_table',
		component: () => import('../views/reference_information/table.vue'),
		meta: {
			index: 0,
			title: '参考信息列表'
		}
	...
	{
		path: '/reference_information/view',
		name: 'reference_information_view',
		component: () => import('../views/reference_information/view.vue'),
		meta: {
			index: 0,
			title: '参考信息详情'
		}
